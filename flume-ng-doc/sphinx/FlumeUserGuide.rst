...
This interceptor extract the last folder name from the given fileHeaderKey and set it to the given folderKey, this is useful when used with the spoolDir source
and setting fileHeader = true and FileHeaderKey = some key but you only want the last folder name.

================  ================  ========================================================================
Property Name     Default           Description
================  ================  ========================================================================
**type**          --                The component type name has to be ``org.apache.flume.interceptor.EventFolderNameInterceptor$Builder``
fileHeaderKey     file              The file header key to extract the folder name from. usually match the fileHeaderKey property in the spoolDir source.
targetFolderKey   defaultFolderKey  The key to store the extracted folder name.
================  ================  ========================================================================

Example 1:
~~~~~~~~~~

If the Flume event header contained ``file=/home/flumeUser/flumeTest/someFile.log`` and the following configuration was used

.. code-block:: properties

  a1.sources.r1.interceptors.i1.type = org.apache.flume.interceptor.EventFolderNameInterceptor$Builder
  a1.sources.r1.interceptors.i1.fileHeaderKey = file
  a1.sources.r1.interceptors.i1.targetFolderKey = targetDir

the extracted event will contain the same body but the following headers will have been added ``targetDir=>flumeTest``
